 ...
 * This fragment is either contained in a {@link TodoListListActivity}
...
public class TodoListDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_todolist_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.todolist_detail)).setText(mItem.details);
        }
